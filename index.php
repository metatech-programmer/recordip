...
c16 -17 42 -54 59 -81z" />
        ...
        <div class="h-100 w-100 text-center d-flex align-items-center p-3">
            <div class="titulo_l p-5" style="border-radius: 25px; background-color: #69a2fa; border: 3px solid #4e54c8;"> <img src="./img/icono.png" alt="Logo" height="100" class="d-inline-block align-text-top mx-3">
    ...
    <footer>
        <div class="derechos-de-autor"><a href="https://santiagoaguilar-devfront.netlify.app/" class="derechos-de-autor text-light text-decoration-none" target="_blank" rel="noopener noreferrer">Created by Santiago
                Aguilar (2023) ©</a></div>
    </footer>
