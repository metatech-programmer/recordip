...
if ($_POST) {
    ...
    if ($tmp_foto != '') {
        ...
        if (isset($registro_recuperado["nombre_imagen"]) && $registro_recuperado["nombre_imagen"] != "") {
            ...
            if (file_exists("./img/" . $registro_recuperado["nombre_imagen"]) && file_exists("../php_dashboard/img/" . $registro_recuperado["nombre_imagen"])) {
                unlink("./img/" . $registro_recuperado["nombre_imagen"]);
                unlink("../php_dashboard/img/" . $registro_recuperado["nombre_imagen"]);
            }
        }
...
=======
    header("Location:http://localhost/app_remembers/php/admin/perfil.php?mensaje=" . $mensaje);
...
<<<<<<< HEAD
                        <a href="./dashboardAdmin.php#?txtID=<?php echo $_SESSION['id']; ?>" class="nav-link"> <button
=======
                        <a href="dashboardAdmin.php#?txtID=<?php echo $_SESSION['id']; ?>" class="nav-link"> <button
>>>>>>> e58a4b94673fa2635cf300002517e4372dff8182
                    ...
                    <div class="perfil ">
                        <form action="" method="post" style=" align-items: baseline!important;"
                            ...
                            <div class="row-2 g-3 my-3">
                                <div class="col  w-100 d-flex">
                                    <input type="text" name="telegram_id" class="form-control w-75" placeholder="Telegram"
