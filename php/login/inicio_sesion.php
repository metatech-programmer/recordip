            ...
            <form action="" method="post">
                ...
                <div class="col-12 my-2">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" class="form-control correo_acceso" title="(prueba> (admin o user)@recordip.com)" name="correo_acceso" id="correo_acceso" placeholder="Correo electronico" list="correo_acceso">
                ...
                <div class="col-12 my-2">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" class="form-control password_acceso" name="password_acceso" id="password_acceso" placeholder="Digite su contraseña " title="(prueba> 123456)" list="password_acceso">
